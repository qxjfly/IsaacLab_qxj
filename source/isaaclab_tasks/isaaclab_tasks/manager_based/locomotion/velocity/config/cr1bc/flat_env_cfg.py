...
from .rough_env_cfg import CR1BCRoughEnvCfg


@configclass
class CR1BCFlatEnvCfg(CR1BCRoughEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.root_height.weight = 1.0 #
        self.rewards.root_height.params["threshold"] = 0.8 #0.88qqq #default 0.85qqq
        self.rewards.body_ang_vel_xy_l2.weight = -1.5
        # Joint deviation
        self.rewards.joint_deviation_leg_yaw.weight = -0.2 #
        self.rewards.joint_deviation_leg_roll.weight = -0.25 #
        self.rewards.joint_deviation_ankle_roll.weight = -0.25 #
        self.rewards.joint_deviation_arms.weight = 0.0 #
        self.rewards.joint_deviation_torso.weight = -0.2 #
        self.rewards.joint_deviation_hip_pitch.weight = 0.0#
        # Joint coordination 
        self.rewards.reward_joint_coordination_hip.weight = 0.0 #-0.5
        ...
        self.rewards.joint_hip_roll_torque_l2.weight = 0.0 #
        self.rewards.joint_knee_torque_l2.weight = 0.0 #
        # Joint action
        self.rewards.action_rate_l2.weight = -0.07 #
        self.rewards.dof_acc_l2.weight = -1.0e-6 #
        self.rewards.dof_acc_l2.params["asset_cfg"] = SceneEntityCfg(
            "robot", joint_names=[".*_hip_.*",".*_knee_.*",".*_ankle_.*","waist_.*"]
        )
        # lowvel
        self.rewards.joint_deviation_zero_lowvel.weight = -0.5 #
        self.rewards.joint_deviation_zero_lowvel.params["asset_cfg"] = SceneEntityCfg(
            "robot", joint_names=[".*_hip_.*",".*_knee_.*",".*_ankle_.*","waist_.*"]
        )
        ...
        self.rewards.joint_coordination_larm_leg.weight = 0.0 #-0.5 #0.5
        self.rewards.joint_coordination_larm_leg.params["ratio"]=1.0
        self.rewards.joint_coordination_rarm_leg.weight = 0.0 #-0.5 #0.5
        self.rewards.joint_coordination_rarm_leg.params["ratio"]=1.0
        #walk phase
        #Gait related rewards
        self.rewards.feet_slide.weight = 0.0#c-0.25 #-0.25 #-0.25 #qxj
        self.rewards.feet_air_time.weight = 0.0 #1.2 #1.5qqq #1.75 #default 1.75
        self.rewards.feet_air_time.params["threshold"] = 0.55 # 0.45 #default 0.45s
        self.rewards.feet_air_height.weight = 0.0 #0.35 #0.3qqq 0.35  0.3
        self.rewards.feet_air_height.params["threshold"] = 0.15 #0.12qqq #0.1 #default 0.12
        self.rewards.step_knee.weight = 0.0 #-8qqq #default -5  -8  -10
        # Joint action
        self.rewards.dof_torques_l2.weight =0.0 # -2.0e-6 
        ...
        # )
        # Joint limits
        self.rewards.joint_knee_pos_limit_l2.weight =0.0 # -1.0
        #walk phase3
        ...
        #Gait
        self.rewards.joint_parallel_ankle_pitch.weight = 0.0 #
        ...
        # self.rewards.joint_deviation_ankle_roll.weight = -1.3# default -1.0 
        # self.rewards.joint_deviation_hip_pitch.weight = 0.0 #-0.02
...
class CR1BCFlatEnvCfg_PLAY(CR1BCFlatEnvCfg):
