...
# Pre-defined configs
##
from isaaclab_assets import G1_MINIMAL_CFG, Wukong4_MINIMAL_CFG, CR01A_MINIMAL_CFG# isort: skip
from isaaclab_assets import CR01B_RL_CFG, CR01BS_RL_CFG, CR01B_RL_CFG # 
