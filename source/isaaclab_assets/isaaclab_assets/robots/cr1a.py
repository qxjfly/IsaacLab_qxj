...
Wukong4_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/user/learning/isaaclab_all/IsaacLab_qxj/Robots_usd/NavAlpha_usd/NavAlpha.usd",
...
CR01A_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/user/learning/isaaclab_all/IsaacLab_qxj/Robots_usd/CR01A_usd/CR01A.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
#     spawn=sim_utils.UsdFileCfg(
#         usd_path="/home/user/learning/isaaclab_all/IsaacLab_qxj/Robots_usd/CR01A_noarm/CR01A_noarm.usd",
#         activate_contact_sensors=True,
#         rigid_props=sim_utils.RigidBodyPropertiesCfg(
#             disable_gravity=False,
#             retain_accelerations=False,
...
CR01B_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/user/learning/isaaclab_all/IsaacLab_qxj/Robots_usd/CRB0_usd/CRB0.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
CR01BS_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/user/learning/isaaclab_all/IsaacLab_qxj/Robots_usd/CRB0_21usd_0905/CRB0_21usd_0905.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    actuators={
        ...
        "feet": ImplicitActuatorCfg(
            ...
            velocity_limit_sim=20.0,
            stiffness={
                ".*_ankle_pitch_joint": 200.0, #30 #150
                ".*_ankle_roll_joint": 100.0, #20 #80
            },
            damping={
                ".*_ankle_pitch_joint": 2.0, #1 #2
                ".*_ankle_roll_joint": 1.0, #0.8 #1
...
"""Configuration for the NavAlpha Humanoid robot."""
CR01BS_RL_CFG = CR01BS_CFG.copy()
CR01BS_amp_CFG = CR01BS_CFG.copy()


################################
CR01BC_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/user/learning/isaaclab_all/IsaacLab_qxj/Robots_usd/CRBC_usd/CRBC.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            ".*_shoulder_pitch_joint": -1.7,
            "left_shoulder_roll_joint": 1.63,
            "right_shoulder_roll_joint": -1.63,
            "left_shoulder_yaw_joint": -2.7,
            "right_shoulder_yaw_joint": 2.7,
            ".*_elbow_pitch_joint": 1.57,
            ".*_wrist_yaw_joint": 2.0,
            ".*_wrist_pitch_joint": 1.3,
    ...
    actuators={
        "legs": DelayedPDActuatorCfg(
            ...
            min_delay = 0,
            max_delay = 1,#self.sim.dt = 0.005  #200hz
        ),
        "feet": ImplicitActuatorCfg(
            joint_names_expr=[".*_ankle_pitch_joint", ".*_ankle_roll_joint"],
            effort_limit_sim={
...
"""Configuration for the NavAlpha Humanoid robot."""
CR01BC_RL_CFG = CR01BC_CFG.copy()
CR01BC_amp_CFG = CR01BC_CFG.copy()

#########################################CR01BS_hiproll_update
CR01BSS_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/user/learning/isaaclab_all/IsaacLab_qxj/Robots_usd/CRB0_21usd_0905/CRB0_21usd_0905.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
...
CR01BSS_RL_CFG = CR01BSS_CFG.copy()
CR01BSS_amp_CFG = CR01BSS_CFG.copy()