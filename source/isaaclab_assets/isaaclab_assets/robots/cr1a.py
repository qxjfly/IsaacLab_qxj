...
from isaaclab.actuators import ActuatorNetMLPCfg, DCMotorCfg, ImplicitActuatorCfg, IdentifiedActuatorCfg,DelayedPDActuatorCfg
...
CR01BC_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="/home/ma/Learning/IsaacLab/IsaacLab_qxj/Robots_usd/CRBC_usd/CRBC.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
