...
obs_space = spaces.Box(low=-np.inf, high=np.inf, shape=(77,))  # 根据实际维度修改
...
# 3. 加载预训练权重
checkpoint = torch.load("/home/ma/Learning/IsaacLab/IsaacLab_qxj/logs/skrl/humanoid_amp_walk/2025-06-04_12-12-22_amp_torch/checkpoints/best_agent.pt", weights_only=True)
...
with torch.no_grad():
    ...
    dummy_input = torch.tensor([-3.7957e-02,  7.5483e-02, -3.6718e-01,  1.5321e-02,  1.2162e-02,
        ...
        -7.8120e-02,  3.1711e-01,  2.4620e-01,  9.0132e-02, -2.5432e+00,
         ...
         1.2926e-01, -7.6466e-01]).to(config["device"])
...
# 6. 保存TorchScript模型
traced_model.save("/home/ma/Learning/IsaacLab/IsaacLab_qxj/logs/skrl/humanoid_amp_walk/2025-06-04_12-12-22_amp_torch/checkpoints/exported/policy_amp_06041.pt")
# print("test")
